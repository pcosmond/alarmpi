...
over_temp= "The XJ1 simulator room is over a safe Temperature limit" #change msg to suit
...
EmailTimeDelay=300 #44000 # 21600			# 86400
...
while True:    
    ...
    elapsed_email_time = time.time() - start_email_delay
