...
EMAIL_SPACE=", "
EMAIL_SUBJECT="FFTX SIMULATOR WARNING"      #Change subject to suit
DATE_FORMAT= "%d/%m/%Y"  
...
over_temp= "The FFTX Simulator Room is over a safe Temperature limit"     #change messg to suit
power_failure= "The Power to the FFTX Simulator has failed"       #change messg to suit   
...
def GetTemperature():    
    ...
    filename = "/sys/bus/w1/devices/28-0000043e2abd/w1_slave"
    tfile = open(filename)
    text = tfile.read()
    tfile.close()
