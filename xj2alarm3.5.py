# RTA ver 3.5 latest as from 16th May 2014 Latest tested version update all sections
...
# email settings
user='simulatorrta@flighttrainingadelaide.com'                                      #change privateeyeuser to suit
...
EMAIL_FROM= "TP Simulator XJ2"                                        #change from to suit
EMAIL_SPACE=", "
EMAIL_SUBJECT="TP Simulator Alarm"                                     #Change subject to suit
DATE_FORMAT= "%d/%m/%Y"  
...
# Messages
over_temp= "The XJ2 room is over a safe Temperature limit"           #change msg to suit
power_failure= "The Power to the XJ2 has failed.  "                           #change messg to suit   
email_test= "Daily Email Test - Email operational for XJ2 Simulator "                                #change messg to suit  
# logfile name
...
def GetTemperatureEmail():    #Email sending triggers
    ...
    filenamet = "/sys/bus/w1/devices/28-0000043e2b74/w1_slave"
...
def GetTemperature():        # Privateeyepi triggers
    ...
    subprocess.call(['modprobe', 'w1-gpio'])
    subprocess.call(['modprobe', 'w1-therm'])
    filenamer = "/sys/bus/w1/devices/28-0000043e2b74/w1_slave"
