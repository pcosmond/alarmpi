# LJ ver 3.3 latest as from 28th April 2014 Latest tested version update all sections
...
EMAIL_FROM= "LJ Simulator XJ1"                                        #change from to suit
EMAIL_SPACE=", "
EMAIL_SUBJECT="LJ Simulator Alarm"                                     #Change subject to suit
DATE_FORMAT= "%d/%m/%Y"  
...
# Messages
over_temp= "The XJ1 room is over a safe Temperature limit"           #change msg to suit
power_failure= "The Power to the XJ1 has failed.  "                           #change messg to suit   
email_test= "Daily Email Test - Email operational for XJ1 Simulator "                                #change messg to suit  
# logfile name
...
def GetTemperature():        # Privateeyepi triggers
    ...
    subprocess.call(['modprobe', 'w1-gpio'])
    subprocess.call(['modprobe', 'w1-therm'])
    filenamer = "/sys/bus/w1/devices/28-00000442ff3e/w1_slave"
